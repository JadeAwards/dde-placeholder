...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		chartingText.setFormat(Paths.font('upheavtt.ttf'), 32);
		...
		missingText.setFormat(Paths.font("upheavtt.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function regenMenu():Void {
		...
		for (num => str in menuItems) {
			...
			if(str == 'Skip Time')
			{
				...
				skipTimeText.setFormat(Paths.font("upheavtt.ttf"), 64, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
